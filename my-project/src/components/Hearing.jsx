...
const Hearing = () => {
  return (
    <div className= "pl-[1rem] mt-[40px] bg-gradient-to-r from-blue-700 to-[#3280f4] h-[51rem] md:flex justify-start gap-[15rem]">
     <section className='z-50  pl-[1rem]'>
        <img src={phone} alt="phone" className='w-[70rem] h-[60rem] z-50'/>
     </section>
     <section className='mt-[12rem] hidden md:block '>
